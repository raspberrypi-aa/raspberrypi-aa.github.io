...
_This example will use an analog to digital converter to read the analog voltage across a photoresistor. A photoresistor decreases resistance (and the voltage across it) when it is exposed to light._
...
<img src="./images/MCP3008-Timing.png">
...
![MCP3008 Pinout](./images/MCP3008-Pinout.png)
![Hardware SPI Breadboard](./images/spi_hardware_mcp3008_bb.png)

There is a kernel module that can make use of the Raspberry Pi's built in SPI support. This requires the spidev module. Check if you have it loaded by running 'lsmod | grep spi'. If the module is present, this should be the output
...
### Our first bitbang'd implementation (More difficult)
...
![Bitbang SPI Breadboard](./images/BitbangSPI_bb.png)
